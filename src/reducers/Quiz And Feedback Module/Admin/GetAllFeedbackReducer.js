...
import { FETCH_ALL_QUIZFEEDBACK_REQUEST,FETCH_ALL_QUIZFEEDBACK_SUCCESS,FETCH_ALL_QUIZFEEDBACK_FAILURE } from '../../../actions/Quiz And Feedback Module/Admin/GetAllQuizFeedbackAction'; 
const initialState = { 
    quizfeedback: [],
    loading: false,
    error: null,
